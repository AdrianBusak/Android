...
private val CREATE_TABLE = "create table $TABLE_NAME( " +
        ...
        "${F1Driver::fullName.name} text, " +
        "${F1Driver::firstName.name} text, " +
        "${F1Driver::lastName.name} text, " +
        "${F1Driver::code.name} text, " +
        "${F1Driver::teamName.name} text, " +
        "${F1Driver::teamColour.name} text, " +
        "${F1Driver::driverNumber.name} integer, " +
        "${F1Driver::headshotPath.name} text, " +
        "${F1Driver::meetingKey.name} integer, " +
        "${F1Driver::sessionKey.name} integer, " +
        "${F1Driver::countryCode.name} text, " +
        "${F1Driver::favorite.name} integer" +
        ")"
